...
public class Grid {
    ...
    private int grass_cost = 5;
    private int land_cost = 1;
    ...
    public int getGrass_cost() {return grass_cost;}

    public int getLand_cost() {return land_cost;}
